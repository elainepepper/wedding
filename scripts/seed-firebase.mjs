...
batch.set(wedding.collection("events").doc("reception"), { id: 1, name: "Wedding reception", event_date: "2026-11-07", event_time: "18:30", venue: "The Grand Salon, Grand Hyatt Kuala Lumpur", rsvp_deadline: "2026-09-23", is_enabled: 1, sort_order: 1 }, { merge: true });
