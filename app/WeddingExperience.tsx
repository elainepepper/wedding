...
export function WeddingExperience({ invitationToken, previewMode = false }: { invitationToken?: string; previewMode?: boolean }) {
  ...
  return <main className={`wedding-shell wedding-shell--storybook ${designClasses}`} style={typography}>
    ...
    <section id="invitation" style={textStyle("invitation")} className="scene scene--invitation" data-scene>
    ...
    {tablesAssigned ? <section id="table" style={textStyle("table")} className="scene scene--blush" data-scene>
    ...
    {!hiddenScenes.has("schedule") ? <section id="schedule" style={textStyle("schedule")} className="scene scene--schedule" data-scene>
    ...
    {flyingIn ? <section id="airport" style={textStyle("airport")} className="scene scene--pearl" data-scene>
    ...
    {flyingIn ? <section id="apps" style={textStyle("apps")} className="scene scene--paper" data-scene>
      <div className="scene-content venue-card reveal">
    ...
    {flyingIn ? <section id="shopping" style={textStyle("shopping")} className="scene scene--paper" data-scene>
      <div className="scene-content recommendations-card reveal">
    ...
    {flyingIn ? <section id="pamper" style={textStyle("pamper")} className="scene scene--blush" data-scene>
      <div className="scene-content recommendations-card reveal">
    ...
    {journeyDone && !hiddenScenes.has("wishes") ? <section id="wishes" style={textStyle("wishes")} className="scene scene--wishes" data-scene><img className="scene-art scene-art--wishes-lace" src="/wedding/decor/lace-tape-white.webp" alt="" loading="lazy" aria-hidden="true" /><div className="scene-content wishes-card reveal"><p className="step-label">{rsvp.attendance === "yes" ? "05" : "02"} · From the heart</p><p className="script-kicker">{content.wishesKicker}</p><h2>{content.wishesHeading}</h2>{personalised ? <><label className="full-field"><span>A warm wish for the two of us</span><textarea value={rsvp.wishes} onChange={(event) => update("wishes", event.target.value)} placeholder="A blessing, a memory, a line we can keep…" rows={4} maxLength={1000} /></label>
